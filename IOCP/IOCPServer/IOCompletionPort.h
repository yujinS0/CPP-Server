//// 지금은 사용하지 않음.
//// IOCPServer.h와 EchoServer.h로 분리시킴.
//#pragma once
...
//
//
//		bool bRet = CreateWokerThread(); // IOCP 다루는 스레드 생성
//		if (false == bRet) {
//			return false;
//		}
//
...
//				// 이 단계에서 해당 I/O 객체에 대한 비동기 작업이 완료되면, 완료 포트에 자동으로 알림이 등록됩니다. 
...
//
//		// [3]. 비동기 I/O 작업 시작
//			// I/O 객체에 대해 비동기 작업을 시작
//			// 클라이언트로부터 데이터를 비동기적으로 수신하는 경우 WSARecv 함수(비동기 데이터 수신을 위한 함수)
//		int nRet = WSARecv(pClientInfo->m_socketClient,
//			&(pClientInfo->m_stRecvOverlappedEx.m_wsaBuf),
//			1,
//			&dwRecvNumBytes,
//			&dwFlag,
//			(LPWSAOVERLAPPED) & (pClientInfo->m_stRecvOverlappedEx), // 구조체를 통해 비동기 작업 상태 관리?
//			NULL);
//		// WSARecv는 비동기 작업을 요청한 후 즉시 반환되며, I/O 작업이 완료될 때까지 대기하지 않습니다.
//
